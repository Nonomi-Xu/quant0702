...
from src.data_ingestion.assets.index.config import INDEX_LIST

FILE_PATH_FRONT = "data/index/index_list/"
FILE_NAME = "index_selected_list_now"

@dg.asset(
    group_name="data_ingestion_daily",
    description="每日获取指定A股的代表性指数基础信息 全量更新",
    deps=[dg.AssetKey("Trade_Cal_Daily")],
)
def Index_Selected_List_Now_Daily(context: dg.AssetExecutionContext) -> dg.MaterializeResult:
    """
    每日获取指数基础信息 全量更新
    """
    ...
    index_list = list(INDEX_LIST.keys())
