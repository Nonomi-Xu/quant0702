...
XSII_N = 102
XSII_M = 7
XSII_TD1_COLUMN = f"xsii_td1_{XSII_N}_{XSII_M}"
XSII_TD2_COLUMN = f"xsii_td2_{XSII_N}_{XSII_M}"
XSII_TD3_COLUMN = f"xsii_td3_{XSII_N}_{XSII_M}"
XSII_TD4_COLUMN = f"xsii_td4_{XSII_N}_{XSII_M}"
