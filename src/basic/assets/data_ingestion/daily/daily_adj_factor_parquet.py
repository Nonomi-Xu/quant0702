...
def Daily_adj_factor(context: dg.AssetExecutionContext) -> dg.MaterializeResult:
    ...
    file_path = f"adj_factor/adj_factor/adj_factor_{current_year}.parquet"
...
def Daily_adj_factor_hfq(context: dg.AssetExecutionContext) -> dg.MaterializeResult:
    ...
    try:
        ...
        while current_year_for_search >= 2020 and not found_data:
            # 构建向前查找的文件路径
            search_file_path = f"adj_factor/hfq/hfq_{current_year_for_search}.parquet"
