...
def compute_volume_standard_deviation_20(frame: pl.DataFrame) -> pl.DataFrame:
    r"""
    20 日成交量标准差，Tushare 对应 VSTD20，参数 N=20。

    定义：

        VSTD20_t = std(VOL_{t-19}, ..., VOL_t)
