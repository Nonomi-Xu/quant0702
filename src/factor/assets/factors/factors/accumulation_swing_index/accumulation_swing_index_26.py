...
ASI_WINDOW = 26
ASIT_WINDOW = 10
ASI_COLUMN = f"accumulation_swing_index_{ASI_WINDOW}"
ASIT_COLUMN = f"accumulation_swing_index_average_{ASI_WINDOW}_{ASIT_WINDOW}"


def compute_accumulation_swing_index_26(frame: pl.DataFrame) -> pl.DataFrame:
    r"""
    ASI 主线因子，参数 M1=26。
