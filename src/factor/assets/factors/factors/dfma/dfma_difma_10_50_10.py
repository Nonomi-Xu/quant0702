...
DFMA_N2 = 50
DFMA_M = 10
DFMA_DIFMA_COLUMN = f"dfma_difma_{DFMA_N1}_{DFMA_N2}_{DFMA_M}"


def compute_dfma_difma_10_50_10(frame: pl.DataFrame) -> pl.DataFrame:
    r"""
    ...
    return frame.select(
        ...
        (pl.col("ma_10") - pl.col("ma_50")).alias("dfma_dif_base")
    ).select(
        "trade_date",
        "ts_code",
