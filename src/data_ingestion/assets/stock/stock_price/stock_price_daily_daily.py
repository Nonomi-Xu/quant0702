...
FILE_PATH_FRONT = "data/stock/stock_price/stock_price_daily/"
FILE_NAME = "stock_price_daily"
...
def Stock_Price_Daily_Daily(context: dg.AssetExecutionContext) -> dg.MaterializeResult:
    """
    增量更新每日股票日线数据
    """
    ...
    for idx, trade_date in enumerate(date_list, start=1):
        ...
        df = tushare_api.daily(trade_date=trade_date)
