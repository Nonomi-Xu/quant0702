...
FILE_PATH_FRONT = "data/stock/stock_price/stock_price_limit/"
FILE_NAME = "stock_price_limit"
...
def Stock_Price_Limit_Daily(context: dg.AssetExecutionContext) -> dg.MaterializeResult:
    """
    增量更新每日股票涨跌停价格
    """
